...
return [
    ...
    'title' => 'Expense Splitter API Documentation',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'RESTful API لإدارة وتسوية المصاريف المشتركة بين المجموعات — سكن مشترك، رحلات، فرق عمل.',
...
- مصادقة بالتوكنات (Laravel Sanctum)
- إدارة مجموعات بصلاحيات متدرّجة
- تقسيم المصاريف تلقائياً بين الأعضاء
- حساب أرصدة كل عضو
- خوارزمية تبسيط الديون
- تسجيل التسويات
INTRO,

    // The base URL displayed in the docs.
    // If you're using `laravel` type, you can set this to a dynamic string, like '{{ config("app.tenant_url") }}' to get a dynamic base URL.
    'base_url' => 'https://expense-splitter.freehosting.dev',
    ...
    'auth' => [
        ...
        'extra_info' => 'يمكنك الحصول على التوكن عبر تسجيل الدخول من نقطة النهاية <code>/api/v1/login</code>.',
    ],
